...
Keep models and PP-OCR ONNX files outside Git; see [architecture](docs/architecture.md#required-local-assets).
...
See [architecture](docs/architecture.md) for the validation checklist.
